...
// isVillage = await locationModel.find({village:location});
// isVillage = await locationModel.findOne({
//   villages: { $in: [location] }
// });
const villages = await getVillages();
if(villages.includes(location)){
  isVillage = true;
}
console.log("jhhjh",isVillage);
console.log(isDistrict,"jhjh",isMandal,"gvfg",isVillage);
